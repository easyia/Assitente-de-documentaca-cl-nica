		...
		extend: {
			colors: {
				...
				soap: {
					...
					'subjective-light': 'hsl(var(--soap-subjective-light))',
					objective: 'hsl(var(--soap-objective))',
					'objective-light': 'hsl(var(--soap-objective-light))',
					assessment: 'hsl(var(--soap-assessment))',
					'assessment-light': 'hsl(var(--soap-assessment-light))',
					plan: 'hsl(var(--soap-plan))',
					'plan-light': 'hsl(var(--soap-plan-light))'
				},
				success: {
